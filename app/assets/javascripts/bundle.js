...
var Ajax = {
  init: function init() {
    $(document).on('dblclick', '[data-editable]', function (event) {
    ...
    $(document).on('change', 'input[data-ajax], select[data-ajax]', function (event) {
      ...
      $.ajax({
        ...
        if ($element.is('select')) {
          ...
          $element.find(':selected').attr('selected', 'selected').siblings().removeAttr('selected');
        }
      }).fail(function (req) {
        Ajax.insertFlash('error', req.responseText);
  ...
  insertFlash: function insertFlash(cssClass, msg) {
    $('#ajax-flash').append($('<div/>', { 'class': cssClass, html: escapeHTML(msg) })).show();
  },

  clearFlash: function clearFlash() {
    $('#ajax-flash').fadeOut('slow', function () {
      $(this).hide();
    }).empty();
  },
  ...
  setupPreviewLink: function setupPreviewLink(options) {
    $('<a href="#"><i class="fa fa-refresh"></i></a>').appendTo('#preview_link').on('click', function () {
      var spinner = new Wincent.Spinner('#preview_link', 'small');
      var data = [],
          max = options.include.length;
      for (var i = 0; i < max; i++) {
        var included = $('#' + options.kind + '_' + options.include[i]).val();
  ...
  observeField: function observeField(options) {
    // defaults
    var $field = options.field || $('#' + options.kind + '_' + options.fieldName),
      ...
      Ajax.insertFlash('error', req.responseText);
        ...
        _complete = options.complete || function () {
      $('#preview_spinner').hide();
    };

    if (typeof window.observed_field_contents === 'undefined') window.observed_field_contents = {};
    ...
    setInterval(function () {
      ...
      if (new_content !== old_content) {
        ...
        if (options.include) {
          ...
          for (var i = 0; i < max; i++) {
            var included = $('#' + options.kind + '_' + options.include[i]).val();
            data += '&' + options.include[i] + '=' + encodeURIComponent(included);
          }
        }
        $.ajax({
          url: options.url,
...
},{"./Keys":5,"./escapeHTML":15,"jquery":"jquery"}],2:[function(require,module,exports){
'use strict';
...
var _injectTagWidget = require('./injectTagWidget');

var _injectTagWidget2 = _interopRequireDefault(_injectTagWidget);

'use strict';

exports['default'] = {
  init: function init() {
    _injectTagWidget2['default']('article');
  }
};
...
exports['default'] = {
  init: function init() {
    _injectTagWidget2['default']('issue');
  }
};
module.exports = exports['default'];
...
var Menu = (function () {
  function Menu() {
    ...
    this.$app = $(this.appSelector).on('click', this.close.bind(this)).on('transitionend oTransitionEnd webkitTransitionEnd', // IE/Moz, Opera, WebKit
    this.handleTransitionEnd.bind(this));

    $(this.menuButtonSelector).on('click', this.handleMenuButtonClick.bind(this));
  }

  _createClass(Menu, [{
    key: 'handleMenuButtonClick',
    value: function handleMenuButtonClick(event) {
      this.toggle();
...
exports['default'] = {
  init: function init() {
    _injectTagWidget2['default']('post');
  }
};
module.exports = exports['default'];
...
exports['default'] = {
  init: function init() {
    _injectTagWidget2['default']('snippet');
  }
};
module.exports = exports['default'];
...
},{"jquery":"jquery","spin.js":173,"underscore":"underscore"}],10:[function(require,module,exports){
'use strict';
...
var _Autocomplete = require('./TagWidget/Autocomplete.react');

var _Autocomplete2 = _interopRequireDefault(_Autocomplete);

var _Input = require('./TagWidget/Input.react');
...
var _Pill = require('./TagWidget/Pill.react');
...
var TagWidget = (function (_React$Component) {
  function TagWidget(props) {
    ...
    _get(Object.getPrototypeOf(TagWidget.prototype), 'constructor', this).call(this, props);
    var tags = props.pendingTags && props.pendingTags.trim().length && props.pendingTags.trim().split(/ +/) || [];
    this.state = {
  ...
  _createClass(TagWidget, [{
    ...
    value: function filterCompletions(string) {
      if (string === '') {
        ...
        return this.state.availableCompletions.filter(function (completion) {
          ...
          return completion.indexOf(string) !== -1 && this.state.tags.indexOf(completion) === -1;
        }, this);
      }
    }
  }, {
    key: 'clearDuplicateMarker',
    ...
    value: function clearDuplicateMarker() {
    ...
    key: 'onShiftTab',
    value: function onShiftTab() {
      var event = document.createEvent('Events');
      event.initEvent('keydown', true, true);
      event.keyIdentifier = 'U+0009';
      event.keyCode = _Keys2['default'].TAB;
      event.which = _Keys2['default'].TAB;
      event.shiftKey = true;
    ...
    value: function handleClick(event) {
      ...
      var tagInput = _React2['default'].findDOMNode(this._tagInput);
    ...
    value: function handleChange(event) {
      ...
      if (event.target === tagInput) {
        (function () {
          var oldList = _this3.state.filteredCompletions;
          var newList = _this3.filterCompletions(tagInput.value);

          if (newList.length !== oldList.length || newList.some(function (string, idx) {
            return oldList[idx] !== string;
          })) {
            _this3.setState({ filteredCompletions: newList });
          }

          _this3.clearDuplicateMarker();
        })();
      }
    }
  }, {
    key: 'handleLeftKeyDown',
    ...
    // pills), does nothing.
    value: function handleLeftKeyDown(event) {
      var input = _React2['default'].findDOMNode(this._tagInput);
    ...
    value: function handleRightKeyDown() {
      if (typeof this.state.selectedPillIndex !== 'undefined') {
        if (this.state.selectedPillIndex < this.state.tags.length - 1) {
          ...
          _React2['default'].findDOMNode(this._tagInput).focus();
        }
        event.preventDefault();
      }
    }
    ...
    value: function handleKeyDown(event) {
      ...
      var completions = this.state.filteredCompletions;
      var maxSelectedIdx = completions.length - 1; // -1 if no completions
      var oldSelectedIdx = this.state.selectedAutocompleteIndex;
      var newSelectedIdx = undefined;

      if (keyCode === _Keys2['default'].LEFT) {
        return this.handleLeftKeyDown(event);
      } else if (keyCode === _Keys2['default'].RIGHT) {
        return this.handleRightKeyDown();
      } else if (keyCode === _Keys2['default'].BACKSPACE || keyCode === _Keys2['default'].DELETE) {
        return this.handleDelete(event);
      } else if (keyCode === _Keys2['default'].ESCAPE) {
        _React2['default'].findDOMNode(this._tagInput).blur();
        this.state.filteredCompletions = [];
      } else if (typeof oldSelectedIdx === 'undefined' && maxSelectedIdx >= 0 && (keyCode === _Keys2['default'].DOWN || keyCode === _Keys2['default'].TAB)) {
        ...
        if (keyCode === _Keys2['default'].UP && oldSelectedIdx > 0) {
          newSelectedIdx = oldSelectedIdx - 1;
        } else if (keyCode === _Keys2['default'].DOWN && oldSelectedIdx < maxSelectedIdx) {
          newSelectedIdx = oldSelectedIdx + 1;
        } else if (keyCode === _Keys2['default'].RETURN || keyCode === _Keys2['default'].TAB) {
          // accept selected suggestion
          _React2['default'].findDOMNode(this._tagInput).value = '';
          this.pushTag(this.state.filteredCompletions[oldSelectedIdx]);
        } else {
          // non-special keys are allowed to pass through
          return;
        }
      } else if (keyCode === _Keys2['default'].RETURN) {
        // no completions selected; add currently inputed text
        var _input = _React2['default'].findDOMNode(this._tagInput);
        var _value = _input.value;
        if (this.pushTag(_value)) {
    ...
    value: function handleBlur(event) {
      if (typeof this.state.selectedPillIndex !== 'undefined' && _React2['default'].findDOMNode(this) === event.target) {
        this.setState({ selectedPillIndex: undefined });
      }
    }
  }, {
     ...
     */
    value: function pushTag(newTag) {
      var pushedTag = undefined;

      newTag = newTag.trim().toLowerCase().replace(/ +/g, '.') // spaces become dots
    ...
    key: 'createTagging',
    value: function createTagging(newTag) {
      var _this4 = this;
      ...
      setTimeout(function () {
        var pending = _this4.state.pending.slice(0);
        pending.splice(pending.indexOf(newTag), 1);
        _this4.setState({ pending: pending });
      }, 1000);
    }
  }, {
    key: 'onTagPush',
    ...
    value: function onTagPush(newTag) {
      var input = _React2['default'].findDOMNode(this._tagInput);
      input.value = '';
      this.pushTag(newTag);
    }
    ...
    key: 'onTagSelect',
    value: function onTagSelect(name) {
      this.setState({ selectedPillIndex: this.state.tags.indexOf(name) });
      this.forceFocus();
    }
  }, {
    key: 'onTagDelete',
    value: function onTagDelete(name) {
      this.clearDuplicateMarker();
      var tags = this.state.tags.slice(0);
    ...
    key: '_renderTagPills',
    value: function _renderTagPills() {
      var _this5 = this;

      return this.state.tags.map(function (name, i) {
        return _React2['default'].createElement(TagWidget.Pill, {
          isDuplicate: name === _this5.state.duplicateTag,
          isPending: _this5.state.pending.indexOf(name) !== -1,
          isSelected: i === _this5.state.selectedPillIndex,
          key: name,
          name: name,
          onTagDelete: _this5.onTagDelete.bind(_this5),
          onTagSelect: _this5.onTagSelect.bind(_this5)
        });
      });
    }
  }, {
    ...
    value: function render() {
      ...
      return _React2['default'].createElement(
        ...
        _React2['default'].createElement(TagWidget.Autocomplete, {
    ...
    key: 'Input',
    value: _Input2['default'],
    enumerable: true
  }, {
    key: 'Pill',
    value: _Pill2['default'],
    enumerable: true
  }]);
...
var Autocomplete = (function (_React$Component) {
  ...
  _createClass(Autocomplete, [{
    ...
    value: function componentDidUpdate() {
      var menu = _React2['default'].findDOMNode(this);
      var selection = this._selected && _React2['default'].findDOMNode(this._selected);

      if (selection) {
        // is selection off the bottom of the scrollable area?
        var count = VISIBLE_AUTOCOMPLETE_ENTRIES;
        var bottomDelta = selection.offsetTop - (menu.scrollTop + count * selection.clientHeight);
        if (bottomDelta > 0) {
          menu.scrollTop += bottomDelta + selection.clientHeight;
        }

        // is selection off the top of the scrollable area?
        var topDelta = menu.scrollTop - selection.offsetTop;
        if (topDelta > 0) {
...
},{"classnames":18,"react":"react"}],12:[function(require,module,exports){
'use strict';
...
var Input = (function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function handleKeyDown(event) {
      var keyCode = event.keyCode;
      var input = _React2['default'].findDOMNode(this);

      if (keyCode === _Keys2['default'].BACKSPACE) {
        if (input.selectionStart !== 0 && input.selectionEnd !== 0) {
          this.pendingDeletion = true;
        } else if (input.selectionStart === 0 && input.selectionEnd === 0 && !this.pendingDeletion) {
      ...
      } else if (keyCode === _Keys2['default'].TAB && event.shiftKey) {
    ...
    key: 'getTextWidth',
    value: function getTextWidth(input) {
      ...
      var value = _escapeHTML2['default'](input.value + 'w'); // 1-char of padding
...
},{"../Keys":5,"../escapeHTML":15,"react":"react"}],13:[function(require,module,exports){
'use strict';
  ...
  _createClass(Pill, [{
    ...
    value: function render() {
      ...
      return _React2['default'].createElement(
        ...
        _React2['default'].createElement(
          'a',
          { href: '#', onClick: this.handleDelete.bind(this) },
          '×'
        )
      );
    }
...
},{"classnames":18,"react":"react"}],14:[function(require,module,exports){
'use strict';
...
exports['default'] = {
  init: function init() {
    _injectTagWidget2['default']('topic');
  }
};
module.exports = exports['default'];
 ...
 */
exports['default'] = injectTagWidget;

var _React = require('react');

var _React2 = _interopRequireDefault(_React);

var _TagWidget = require('./TagWidget.react');
...
function injectTagWidget(modelName) {
  ...
  if (input) {
    ...
    _React2['default'].render(_React2['default'].createElement(_TagWidget2['default'], {
...
},{"./TagWidget.react":10,"react":"react"}],17:[function(require,module,exports){
...
},{"./CSSProperty":21,"./ExecutionEnvironment":38,"./camelizeStyleName":126,"./dangerousStyleValue":131,"./hyphenateStyleName":151,"./memoizeStringOnly":161,"./warning":172,"_process":17}],23:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":44,"./PooledClass":45,"./invariant":153,"_process":17}],24:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Danger":29,"./ReactMultiChildUpdateTypes":90,"./invariant":153,"./setTextContent":167,"_process":17}],27:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":153,"_process":17}],28:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./DOMProperty":27,"./quoteAttributeValueForBrowser":165,"./warning":172,"_process":17}],29:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":38,"./createNodesFromMarkup":130,"./emptyFunction":132,"./getMarkupWrap":145,"./invariant":153,"_process":17}],30:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./emptyFunction":132,"_process":17}],34:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventPluginRegistry":35,"./EventPluginUtils":36,"./accumulateInto":123,"./forEachAccumulated":138,"./invariant":153,"_process":17}],35:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":153,"_process":17}],36:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":32,"./invariant":153,"_process":17}],37:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./EventConstants":32,"./EventPluginHub":34,"./accumulateInto":123,"./forEachAccumulated":138,"_process":17}],38:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactPropTypes":96,"./invariant":153,"_process":17}],42:[function(require,module,exports){
(function (process){
/**
...
},{"./ReactBrowserEventEmitter":48,"./accumulateInto":123,"./forEachAccumulated":138,"./invariant":153,"_process":17}],43:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":153,"_process":17}],46:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./PooledClass":45,"./ReactFragment":81,"./traverseAllChildren":171,"./warning":172,"_process":17}],51:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactUpdateQueue":104,"./invariant":153,"./warning":172,"_process":17}],53:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":153,"_process":17}],55:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./Object.assign":44,"./emptyObject":133,"./warning":172,"_process":17}],57:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":75,"./ReactElementValidator":76,"./mapObject":160,"_process":17}],59:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":22,"./DOMProperty":27,"./DOMPropertyOperations":28,"./Object.assign":44,"./ReactBrowserEventEmitter":48,"./ReactComponentBrowserEnvironment":53,"./ReactMount":88,"./ReactMultiChild":89,"./ReactPerf":93,"./escapeTextContentForBrowser":134,"./invariant":153,"./isEventSupported":154,"./keyOf":159,"./warning":172,"_process":17}],61:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./CSSPropertyOperations":22,"./DOMChildrenOperations":26,"./DOMPropertyOperations":28,"./ReactMount":88,"./ReactPerf":93,"./invariant":153,"./setInnerHTML":166,"_process":17}],63:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":19,"./DOMPropertyOperations":28,"./LinkedValueUtils":41,"./Object.assign":44,"./ReactBrowserComponentMixin":47,"./ReactClass":51,"./ReactElement":75,"./ReactMount":88,"./ReactUpdates":105,"./invariant":153,"_process":17}],66:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactBrowserComponentMixin":47,"./ReactClass":51,"./ReactElement":75,"./warning":172,"_process":17}],67:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./AutoFocusMixin":19,"./DOMPropertyOperations":28,"./LinkedValueUtils":41,"./Object.assign":44,"./ReactBrowserComponentMixin":47,"./ReactClass":51,"./ReactElement":75,"./ReactUpdates":105,"./invariant":153,"./warning":172,"_process":17}],71:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":44,"./ReactContext":56,"./ReactCurrentOwner":57,"./warning":172,"_process":17}],76:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactCurrentOwner":57,"./ReactElement":75,"./ReactFragment":81,"./ReactNativeComponent":91,"./ReactPropTypeLocationNames":94,"./ReactPropTypeLocations":95,"./getIteratorFn":144,"./invariant":153,"./warning":172,"_process":17}],77:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":75,"./ReactInstanceMap":85,"./invariant":153,"_process":17}],78:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":75,"./warning":172,"_process":17}],82:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactRootIndex":101,"./invariant":153,"_process":17}],85:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":44,"./invariant":153,"_process":17}],92:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":153,"_process":17}],93:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElementValidator":76,"./ReactRef":100,"_process":17}],100:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":75,"./ReactInstanceHandles":84,"./ReactMarkupChecksum":87,"./ReactServerRenderingTransaction":103,"./emptyObject":133,"./instantiateReactComponent":152,"./invariant":153,"_process":17}],103:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":44,"./ReactCurrentOwner":57,"./ReactElement":75,"./ReactInstanceMap":85,"./ReactLifeCycle":86,"./ReactUpdates":105,"./invariant":153,"./warning":172,"_process":17}],105:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./CallbackQueue":23,"./Object.assign":44,"./PooledClass":45,"./ReactCurrentOwner":57,"./ReactPerf":93,"./ReactReconciler":99,"./Transaction":121,"./invariant":153,"./warning":172,"_process":17}],106:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":153,"_process":17}],122:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./invariant":153,"_process":17}],124:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactClass":51,"./ReactElement":75,"./invariant":153,"_process":17}],130:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ExecutionEnvironment":38,"./createArrayFromMixed":128,"./getMarkupWrap":145,"./invariant":153,"_process":17}],131:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"_process":17}],134:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactCurrentOwner":57,"./ReactInstanceMap":85,"./ReactMount":88,"./invariant":153,"./isNode":155,"./warning":172,"_process":17}],136:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./traverseAllChildren":171,"./warning":172,"_process":17}],137:[function(require,module,exports){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ExecutionEnvironment":38,"./invariant":153,"_process":17}],146:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./Object.assign":44,"./ReactCompositeComponent":55,"./ReactEmptyComponent":77,"./ReactNativeComponent":91,"./invariant":153,"./warning":172,"_process":17}],153:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":153,"_process":17}],159:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./ReactElement":75,"./invariant":153,"_process":17}],163:[function(require,module,exports){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
 *
...
},{"./warning":172,"_process":17}],170:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./invariant":153,"_process":17}],171:[function(require,module,exports){
(function (process){
/**
 * Copyright 2013-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./ReactElement":75,"./ReactFragment":81,"./ReactInstanceHandles":84,"./getIteratorFn":144,"./invariant":153,"./warning":172,"_process":17}],172:[function(require,module,exports){
(function (process){
/**
 * Copyright 2014-2015, Facebook, Inc.
 * All rights reserved.
...
},{"./emptyFunction":132,"_process":17}],173:[function(require,module,exports){
/**
...
},{"./lib/React":46}],"underscore":[function(require,module,exports){
//     Underscore.js 1.8.3
...
},{}],"wincent":[function(require,module,exports){
'use strict';
...
},{"./Ajax":1,"./Articles":2,"./Git":3,"./Issues":4,"./Menu":6,"./Posts":7,"./Snippets":8,"./Spinner":9,"./Topics":14}]},{},[]);
