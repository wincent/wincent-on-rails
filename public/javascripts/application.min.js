...
function relativizeDates(){$(".relative-date").each(function(){var a=this.innerHTML,b=new Date,c=dateFromUTCString(a);a=b.getTime()-c.getTime();a=Math.round(a/1E3);a<0?a="in the future":a===0?a="now":a<60?a="a few seconds ago":a<120?a="a minute ago":a<180?a="a couple of minutes ago":a<300?a="a few minutes ago":a<3600?a=Math.round(a/60)+" minutes ago":a<7200?a="an hour ago":a<86400?a=Math.round(a/3600)+" hours ago":(a=Math.round(a/86400),a===1?a="yesterday":a<=7?a+=" days ago":(a=Math.round(a/7),a=
a===1?"a week ago":a<=6?a+" weeks ago":c.toLocaleDateString()));this.title=c.toLocaleString();this.innerHTML=a})}
...
null,$(this).attr("data-popup"));return!1})});
