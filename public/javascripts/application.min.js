...
$(document).ready(function(){setUpLoginLogoutLinks();setUpSearchLink();displayCacheableFlash();relativizeDates();highlightActiveFragment();$("body").syntaxHighlight();$("input[data-confirm]").live("click",function(){return confirm($(this).attr("data-confirm"))});$("form[data-remote]").live("submit",function(a){var b=$(this);$.ajax({url:b.attr("action")+".js",type:"post",data:"_method=delete",error:function(){alert("Failed to delete")}});a.preventDefault()});$("a[data-popup]").live("click",function(){window.open(this.href,
null,$(this).attr("data-popup"));return false})});
