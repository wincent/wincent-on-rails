...
function setUpLoginLogoutLinks(){var a=getCookie("user_id");a==null||a==""?$("#logout").remove():$("#login").remove()}function insertFlash(a,c){c&&$("#cacheable-flash").append('<div id="'+a+'">'+c+"</div>")}function displayCacheableFlash(){var a=getCookie("flash");if(a){a=unescape(a).replace(/\+/g," ");a=eval("flash = "+a+";");insertFlash("error",a.error);insertFlash("notice",a.notice);deleteCookie("flash")}}
