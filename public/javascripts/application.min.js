function getCookie(a){for(var c=document.cookie.split("; "),b=0;b<c.length;b++){var d=c[b],e=d.indexOf("=");if(d.substring(0,e)==a)return d.substring(e+1)}return null}function setCookie(a,c,b){a=escape(a)+"="+escape(c||"")+";";if(b){c=new Date;c.setTime(c.getTime()+1E3*parseInt(b));a=a+" expires="+c.toGMTString()+";"}a+=" path=/;";return document.cookie=a}function deleteCookie(a){return setCookie(a,null,-86400)}
function setUpLoginLogoutLinks(){var a=getCookie("user_id");a==null||a==""?$("#logout").remove():$("#login").remove()}function insertFlash(a,c){c&&$("#cacheable-flash").append($("<div/>",{"class":a,html:c}))}function displayCacheableFlash(){var a=getCookie("flash");if(a){a=unescape(a).replace(/\+/g," ");a=eval("flash = "+a+";");insertFlash("error",a.error);insertFlash("notice",a.notice);deleteCookie("flash")}}
function relativizeDates(){$(".relative-date").each(function(){var a=this.innerHTML,c=new Date;a=new Date(a);var b=c.getTime()-a.getTime();c=new Array("January","February","March","April","May","June","July","August","September","October","November","December");b=Math.round(b/1E3);if(b<0)a="in the future";else if(b==0)a="now";else if(b<60)a="a few seconds ago";else if(b<120)a="a minute ago";else if(b<180)a="a couple of minutes ago";else if(b<300)a="a few minutes ago";else if(b<3600)a=Math.round(b/
