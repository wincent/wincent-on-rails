var global_spinner_counter=0;function escapeHTML(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function insertAJAXFlash(a,c){$("#ajax-flash").html('<div class="'+a+'">'+escapeHTML(c)+"</div>").show()}function clearAJAXFlash(){$("#ajax-flash").fadeOut("slow",function(){$("#ajax-flash").hide()})}
