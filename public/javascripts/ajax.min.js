var global_spinner_counter=0;function escapeHTML(a){return a.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function insertAJAXFlash(a,c){$("#ajax-flash").append($("<div/>",{"class":a,html:escapeHTML(c)})).show();alert("worked")}function clearAJAXFlash(){$("#ajax-flash").fadeOut("slow",function(){$(this).hide()})}
